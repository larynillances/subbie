    ...
    <div class="col-lg-4">
        ...
        <table class="table table-responsive table-colored-header">
            ...
            if(count($wage_type)>0):
                ...
                ?>
                <tr>
                    <td colspan="3" class="empty-table">No data was found.</td>
                </tr>
            <?php
            endif;
            ?>
    ...
    <div class="col-lg-2">
        ...
        <table class="table table-responsive table-colored-header">
            ...
            if(count($salary_type)>0):
                ...
                ?>
                <tr>
                    <td class="empty-table">No data was found.</td>
                </tr>
            <?php
            endif;
            ?>
    ...
    <div class="col-lg-7">
        ...
        <table class="table table-responsive table-colored-header">
            ...
            if(count($deductions)>0):
                ...
                ?>
                <tr>
                    <td colspan="8" class="empty-table">No data was found.</td>
                </tr>
            <?php
            endif;
            ?>
    ...
    <div class="col-lg-5">
        ...
        <table class="table table-colored-header table-responsive">
            ...
            if(count($employee)>0):
                ...
                ?>
                <tr>
                    <td colspan="4" class="empty-table">No data was found.</td>
                </tr>
            <?php
            endif;
            ?>
