        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="client_name" id="client_name" class="form-control input-sm required">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="code">Code</label>
                    <div class="col-sm-8">
                        <input type="text" name="client_code" id="code" class="form-control input-sm required">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="contact_name">Contact Name</label>
                    <div class="col-sm-8">
                        <input type="text" name="contact_name" id="contact_name" class="form-control input-sm required">
                    </div>
                </div>
                <div class="form-group">
                ...
                <fieldset>
                    ...
                    <table class="takeOffReturnTable">
                        <tr>
                            ...
                            <td style="width: 10px;">
                                <input type="checkbox" name="via_subbie_only" id="via_eotl_only" class="eotlReturnTypeOnly" value="1" disabled/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_name" autocomplete="off" class="takeOffEmailInfo form-control input-sm" placeholder="Client Staff Name" disabled/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_email" id="take_off_merchant_email" autocomplete="off" class="takeOffEmailInfo form-control input-sm merchantReturnEmail" placeholder="Client Staff Email Address" disabled/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_cc[cc_one_name]" autocomplete="off" class="takeOffEmailInfo form-control input-sm merchantCCReturnEmail" placeholder="Client CC1 Name" disabled/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_cc[cc_one_email]" id="cc_one_email" autocomplete="off" class="takeOffEmailInfo form-control input-sm merchantCCReturnEmail" placeholder="Client CC1 Email Address" disabled/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_cc[cc_two_name]" autocomplete="off" class="takeOffEmailInfo form-control input-sm merchantCCReturnEmail" placeholder="Client CC2 Name" disabled/>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_merchant_cc[cc_two_email]" id="cc_two_email" autocomplete="off" class="takeOffEmailInfo form-control input-sm merchantCCReturnEmail" placeholder="Client CC2 Email Address" disabled/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2"></td>
                            <td colspan="2" class="input-data">
                                <input type="text" name="take_off_franchise_email" id="take_off_franchise_email" autocomplete="off" class="takeOffEmailInfo form-control input-sm franchiseReturnEmail" placeholder="Copy to Franchise Administrator" disabled/>
                            </td>
                        </tr>
                        <tr>
                            <td>
