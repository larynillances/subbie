...
<div class="modal-body">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <?php echo form_dropdown('account_type_id[]',$account_type,$account_ids,'multiple="multiple" class="multiple-selected form-control input-sm"')?>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-3" for="menu">Form:</label>
        <div class="col-sm-8">
            <?php echo form_dropdown('form_id[]',$downloadable_form,$menu_ids,'multiple="multiple" class="multiple-selected form-control input-sm"')?>
        </div>
    </div>
</div>
