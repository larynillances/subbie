...
$.extend(Datepicker.prototype, {
	...
	_tidyDialog: function(inst) {
		inst.dpDiv.removeClass(this._dialogClass).unbind('.ui-datepicker-dtr');
	},
		...
		for (var row = 0; row < numMonths[0]; row++) {
			...
			for (var col = 0; col < numMonths[1]; col++) {
				...
				calender += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + cornerClass + '">' +
					...
					'</div><table class="ui-datepicker-dtr"><thead>' +
					'<tr>';
...
function bindHover(dpDiv) {
	var selector = 'button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-dtr td a';
	return dpDiv.delegate(selector, 'mouseout', function() {
		...
		.delegate(selector, 'mouseover', function(){
			if (!$.datepicker._isDisabledDatepicker( instActive.inline ? dpDiv.parent()[0] : instActive.input[0])) {
				$(this).parents('.ui-datepicker-dtr').find('a').removeClass('ui-state-hover');
				$(this).addClass('ui-state-hover');
